...
init_pos = find_initial_positions(freq, rank)
x, y, z = np.load('precomputed_strain_params/x.npy'),  np.load('precomputed_strain_params/y.npy'),  np.load('precomputed_strain_params/z.npy')
xi3 = np.load('precomputed_strain_params/xi3.npy')
...
mf = Manifold(init_pos, dom_bound, max_geo_dist, min_s_step, max_s_step, dist, dist_tol, plane_tol, tan_tol, min_ang, max_ang, min_dist_ang, max_dist_ang, min_sep, max_sep,timelimit)
...
l = [mf]
np.save(path+'{}_manifold.npy'.format(rank),l)
