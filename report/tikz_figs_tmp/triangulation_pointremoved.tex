...
\begin{tikzpicture}[tdplot_main_coords]
    ...
    \node[above right = 0pt and -5pt of doomed,color=gray!80] {\footnotesize $\mathcal{M}_{i+1,j}$};
    \node[above right = -5pt and 2pt of o3] {\footnotesize $\mathcal{M}_{i+1,j+2}$};

    % Place nodes of inner level set
    \node[below left = 0pt and -10pt of i1] {\footnotesize $\mathcal{M}_{i,j-1}$};
    \node[below left = 0pt and -7pt of i2] {\footnotesize $\mathcal{M}_{i,j}$};
    \node[below left = 0pt and -10pt of i3] {\footnotesize $\mathcal{M}_{i,j+1}$};
    \node[below left = 0pt and -10pt of i4] {\footnotesize $\mathcal{M}_{i,j+2}$};
    ...
    \begin{scope}[on background layer]
        ...
        \draw[draw=none,pattern=north east lines, pattern color = gray!40] (i2) -- (o3) -- (i3) -- cycle;
        \draw[draw=black!65,dashed] (i2) -- (o3) -- (i3) -- cycle;
