...
\begin{tikzpicture}[tdplot_main_coords]
    ...
    \node[above right = 0pt and -5pt of o2] {\footnotesize $\mathcal{M}_{i+1,j+1}$};
    \node[above right = -1pt and -3.5pt of doomed,color=gray!80] {\footnotesize $\mathcal{M}_{i+1,j}$};
    \node[above right = 0pt and -5pt of o3] {\footnotesize $\mathcal{M}_{i+1,j+2}$};
    ...
    \node[below left = 0pt and -5pt of i3] {\footnotesize $\mathcal{M}_{i,j+1}$};
    \node[below left = 0pt and -5pt of i4] {\footnotesize $\mathcal{M}_{i,j+2}$};


    % Draw interpolation triangles
    \begin{scope}[on background layer]
        \draw[draw=none,pattern=north west lines, pattern color = gray!40] (i2) -- (o2) -- (o3) -- cycle;
        \draw[draw=black!65,dashed] (i2) -- (o2) -- (o3) -- cycle;
        \draw[draw=none,pattern=north west lines, pattern color = gray!40] (i1) -- (o1) -- (i2) -- cycle;
        \draw[draw=black!65,dashed] (i1) -- (o1) -- (i2) -- cycle;
        \draw[draw=none,pattern=north west lines, pattern color = gray!40] (i3) -- (o3) -- (i4) -- cycle;
        \draw[draw=black!65,dashed] (i3) -- (o3) -- (i4) -- cycle;

        \draw[draw=black!65,dashed,fill=gray!35] (i2) -- (o1) -- (o2) -- cycle;
        \draw[draw=black!65,dashed,fill=gray!35] (i2) -- (o3) -- (i3) -- cycle;
%    \draw[draw=none,pattern=north west lines, pattern color = gray!40] (i2) -- (o2) -- (new) -- cycle;
%    \draw[draw=black!65,dashed] (i2) -- (o2) -- (new) -- cycle;
%    \draw[draw=none,pattern=north west lines, pattern color = gray!40] (i3) -- (new) -- (o3) -- cycle;
%    \draw[draw=black!65,dashed] (i3) -- (new) -- (o3) -- cycle;
%    \draw[draw=black!65,dashed,fill=gray!35] (i2) -- (new) -- (i3) -- cycle;
%
%    \draw[draw=none,pattern=north east lines, pattern color = gray!20] (i1) -- (o1) -- (o2) -- cycle;
%    \draw[draw=black!55,dashed] (i1) -- (o1) -- (o2) -- cycle;
%    \draw[draw=black!65,dashed,fill=gray!15] (i1) -- (o2) -- (i2) -- cycle;
