...
\begin{tikzpicture}[tdplot_main_coords]
    ...
    \draw[stroke=black!80,->,densely dashdotted,thick] (o1) to ($(i1)!1.25!(o1)$) coordinate (vf); % Draw 225 % of the path from (i1) to (o1)
    \node[below left = 1.5pt and 3.5pt of vf,rotate=-7.5] {$\vct{\rho}_{i,j}$};
    % Suggested new point
    \coordinate (n1) at ( {5.2*cos(10)} , {5.1*cos(10)}, 0.1 );
    \draw[stroke=black!80,fill=gray!20] (n1) circle (3pt) ;
    % Draw prev_vec for new point
    \draw[stroke=black!80,->,thick] (o1) to (n1) node [below left = 10pt and 5pt]};%($(o1)!0.95!(n1)$);
    ...
    \node at (n1) [below right= 3pt and -5pt] {$\mathcal{M}_{i+1,j}$};
    ...
    \draw[decorate,decoration={brace,amplitude=2.5pt,raise=7.5pt},yshift=0pt] (o1) -- (n1) node [midway,above right = 7.5pt and -12pt,rotate=30] {$\Delta_{i}$};
