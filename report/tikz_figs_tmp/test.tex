...
\usetikzlibrary{angles,calc,decorations,hobby,quotes,arrows.meta,backgrounds,positioning}
...
%    \draw[stroke=black!80,thin,dotted] plot [smooth,tension=0.7] coordinates {(i1) (i2) (i3) (i4) (i5) (i6) (i7) (i8) (i9) (i10) (i11) (i1)};
    ...
    \pic[draw,-{>[scale=1.1]}, stroke=black!80,"$\theta$", angle radius = 15, angle eccentricity = 1.5] {angle= vf--o1--n1};
    ...
    \node at (n1) [below = 5pt] {$\mathcal{P}_{i+1,j}$};
