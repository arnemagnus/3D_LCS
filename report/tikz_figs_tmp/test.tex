...
\newcommand{\vct}[1]{\ensuremath{\bm{\mathup{\MakeLowercase{#1}}}}}

% Define unit vectors in bold, roman, lowercase font, with hats
\newcommand{\uvct}[1]{\ensuremath{\bm{\mathup{\hat{\MakeLowercase{#1}}}}}}

% Define matrices in bold, roman, uppercase font
\newcommand{\mtrx}[1]{\ensuremath{\bm{\mathup{\MakeUppercase{#1}}}}}
\usetikzlibrary{%
    angles,%
    arrows.meta,%
    backgrounds,%
