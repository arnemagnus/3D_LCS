...
%    % Place the set of initial points
    \foreach [count = \i] \ang in {200,240,260,280,165}%
    {%
    ...
    \path[draw,stroke=black!65,->,thick,dashdotted ] (2) to ($(2) + 3*({-0.866},{0.5},0)$) coordinate (rhoend);
    \node[below left = 1pt and 7pt of rhoend,rotate=15] {$\vct{\rho}_{i,j}$};
    ...
    % Draw aim point
    \draw[stroke=black!65,fill=gray!10] ($(2) + 1.2*({-0.866},{0.5},0) + (0,0,0.75)$) circle (\size pt) coordinate (aim);
