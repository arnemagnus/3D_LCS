...
\begin{tikzpicture}
    \node[align=center] (initial) [block] {Does the M{\"o}ller-Trumbore algorithm suggest that\\any ray emanating from a vertex of A, passing\\through another vertex of A, intersects B?};
