...
%    \draw[draw=gray!70,fill=gray!10] ( {\innerradius*cos(76)}, {\innerradius*sin(76)}, 0) circle (\size pt) coordinate (ghost);
    ...
    \draw[draw=gray!70,fill=gray!10] ($(doomed3)+(-{0.4},{1.2},0)$) circle (\size pt) coordinate (doomed4);
    \draw[draw=gray!70,fill=gray!10] ($(doomed4)+(-{0.7},{0.25},0)$) circle (\size pt) coordinate (doomed5);
    \draw[draw=gray!70,fill=gray!10] ($(doomed5)+(-{0.9},-{0.15},0)$) circle (\size pt) coordinate (doomed6);
