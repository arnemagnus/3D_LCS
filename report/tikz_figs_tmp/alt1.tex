...
\begin{tikzpicture}[tdplot_main_coords]
    ...
    \node[above right = -1pt and -7.5pt of doomed] {\footnotesize $\mathcal{M}_{i,j+1}$};
    \node[above right = -2.5pt and -5pt of i3] {\footnotesize $\mathcal{M}_{i,j+2}$};
    ...
    % Place small bracket
    \draw[decorate,decoration={brace,amplitude=2.5pt,raise=5pt},yshift=0pt] (sb2) -- (sb1) node [midway,below right = -5pt and -35pt,rotate=-16] {\footnotesize $\norm{\vct{x}_{i+1,j+1}-\vct{x}_{i+1,j}} < \Delta_{\min}$};
    ...
    % Place first bracket
    \draw[decorate,decoration={brace,amplitude=2.5pt,raise=25pt},yshift=0pt] (bb2) -- (bb1) node [midway,below right = 18pt and -40pt,rotate=-11.5] {\footnotesize $\norm{\vct{x}_{i+1,j+2}-\vct{x}_{i+1,j}}$};
    ...
    \draw[decorate,decoration={brace,amplitude=2.5pt,raise=25pt},yshift=0pt] (gb1) -- (gb2) node [midway,above right = 40pt and -20pt,rotate=-26.6] {\footnotesize $\norm{\vct{x}_{i+1,j+1}-\vct{x}_{i+1,j-1}}$};
