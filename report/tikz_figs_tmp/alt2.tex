...
\begin{tikzpicture}[tdplot_main_coords]
    ...
    % Place first bracket
    \draw[decorate,decoration={brace,amplitude=2.5pt,raise=25pt},yshift=0pt] (bb2) -- (bb1) node [midway,below right = 12pt and -40pt,rotate=-20.8] {\footnotesize $\norm{\vct{x}_{i+1,j+2}-\vct{x}_{i+1,j}}$};
    ...
    \draw[decorate,decoration={brace,amplitude=2.5pt,raise=25pt},yshift=0pt] (gb1) -- (gb2) node [midway,above right = 42pt and -8pt,rotate=-40.5] {\footnotesize $\norm{\vct{x}_{i+1,j+1}-\vct{x}_{i+1,j-1}}$};
