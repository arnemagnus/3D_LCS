...
the guidance vector $\vct{\rho}_{i,j}$ (where the latter of which is defined in
\cref{eq:innermost_prevvec,eq:general_prevvec}).

\input{mainmatter/method/levelset_method_take_two/computing_trajectories}

\input{mainmatter/method/levelset_method_take_two/handling_failures_to_compute%
_points}

\input{mainmatter/method/levelset_method_take_two/summary_of_key_improvements}
