\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.43\textwidth}
        \centering
        \resizebox{0.9\linewidth}{!}{\importpgf{figures/mpl-figs}{fjord-abd-domain-view1-small.pgf}}
        \caption[]{{\small Top-down view along the $z$-axis}}
        \label{fig:fjord_abd_z}
    \end{subfigure}\hfill%
    \begin{subfigure}[b]{0.43\textwidth}
        \centering
        \resizebox{0.9\linewidth}{!}{\importpgf{figures/mpl-figs}{fjord-abd-domain-view2-small.pgf}}
    ...
    \begin{subfigure}[b]{0.43\textwidth}
        \centering
        \resizebox{0.9\linewidth}{!}{\importpgf{figures/mpl-figs}{fjord-abd-domain-view3-small.pgf}}
        \caption[]{{\small View along the positive $x$-axis}}
        \label{fig:fjord_abd_x}
    \end{subfigure}\hfill%
    \begin{subfigure}[b]{0.43\textwidth}
        \centering
        \resizebox{0.9\linewidth}{!}{\importpgf{figures/mpl-figs}{fjord-abd-domain-view4-small.pgf}}
    ...
    in the Førde fjord]
    {
        ...
        the Førde fjord, over a time interval of \numprint{12} hours
