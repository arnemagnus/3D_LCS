\begin{figure}[htpb]
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \input{figures/mpl-figs/convergence-minsep=0.16-small.pgf}
        \caption[]{{\small min\_sep = 0.16}}
        \label{fig:u0_dom_err_bs32}
    \end{subfigure}
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \input{figures/mpl-figs/convergence-minsep=0.08-small.pgf}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \input{figures/mpl-figs/convergence-minsep=0.04-small.pgf}
        \caption[]{{\small min\_sep = 0.04}}
        \label{fig:u0_dom_err_dp54}
    \end{subfigure}
    \begin{subfigure}[b]{0.475\textwidth}
        \centering
        \input{figures/mpl-figs/convergence-minsep=0.01-small.pgf}
