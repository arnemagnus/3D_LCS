\section[Verifying our method of extracting repelling LCSs from the computed manifolds]
{Verifying our method of extracting repelling LCSs from the computed manifolds}
