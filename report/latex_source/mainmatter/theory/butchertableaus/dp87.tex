...
\begin{sidewaystable}
    ...
    {Butcher tableau for the Dormand-Prince 8(7) embedded Runge-Kutta method.
        The $b$ coefficients give an \nth{8}-order accurate solution used
        to continue the integration. The $\widehat{b}$ coefficients yield
        ...
        The provided coefficients are rational approximations, accurate to about
        24 significant decimal digits. For reference, see
