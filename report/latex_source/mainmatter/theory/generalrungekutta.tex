...
step. Butcher tableau representations of the classical \nth{4}-order Runge-Kutta
method and the embedded Dormand-Prince 8(7) method are available in
is available in~\cref{tab:butcherrk4,tab:butcherdopri87}; where the latter of
which has been typeset in landscape mode for the reader's convenience. Details
on how the dynamic time step of the Dormand-Prince 8(7) method was implemented
