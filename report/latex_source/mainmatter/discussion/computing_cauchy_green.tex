...
%The added complexity of solving a set of twelve
%coupled ODEs rather than three is a small price to pay for the overall increase
%in the accuracy of the computed eigenvalues and -vectors, compared to methods
%based upon the application of finite differences. In particular, we found our
%approach to yield smoother eigenvalue- and eigenvectorfields than the method of
