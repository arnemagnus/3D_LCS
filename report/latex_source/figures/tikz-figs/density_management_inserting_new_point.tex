...
\begin{tikzpicture}[tdplot_main_coords]
    ...
    \node[below left = -1pt and -7.5pt of ghost,color=gray!80] {\small $\mathcal{M}_{i,j+\frac{1}{2}}$};
    ...
    \node[below right = 2.5pt and -20pt of new] {\small $\mathcal{M}_{i+1,j+\frac{1}{2}}$};
