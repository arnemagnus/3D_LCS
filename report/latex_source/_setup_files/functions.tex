...
\titlespacing*{\chapter}{0pt}{10pt plus 2pt minus 1pt}{-1pt minus 1pt}
...
\titlespacing*{\section}{0pt}{5pt plus 1pt minus 1pt}{-6pt minus 1pt}
...
{\itshape}
[]
\titlespacing*{\subsection}{0pt}{4pt plus 1pt minus 1pt}{-6pt minus 1pt}
...
{}
[]
\titlespacing*{\subsubsection}{0pt}{3pt plus 0.5pt minus 0.5pt}{-6pt minus 1pt}
...
\renewcommand\printtoctitle[1]{\vspace{-15.0ex}\chapter*{#1}}
...
% List of Figures:
\renewcommand\printloftitle[1]{\vspace{-15.0ex}\chapter*{#1}}

\addto\captionsenglish{%
    \renewcommand{\listfigurename}{\protect\vphantom{T}List of
    Figures}%
}


%\addtocontents{lof}{\vspace{-2ex}}
\newlength{\afterlofskip}
\setlength{\afterlofskip}{16pt}
\renewcommand{\afterloftitle}{\par\nobreak\vskip\afterlofskip}

% List of Tables:
\renewcommand\printlottitle[1]{\vspace{-15.0ex}\chapter*{#1}}
...
\newlength{\afterlotskip}
\setlength{\afterlotskip}{16pt}
\renewcommand{\afterlottitle}{\par\nobreak\vskip\afterlotskip}
...
% Define pseudohacky macro to enable e.g. dots and superscripts without
% unnatural spacing
\newcommand{\hckspc}{\ensuremath{\,\!}}

% Define nicefrac command manually
\def\nicefrac#1#2{%
