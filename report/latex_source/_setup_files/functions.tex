...
\renewcommand\printtoctitle[1]{\vspace{-15.25ex}\chapter*{#1}}
...
% List of Figures:
\renewcommand\printloftitle[1]{\vspace{-15.25ex}\chapter*{#1}}
...
% List of Tables:
\renewcommand\printlottitle[1]{\vspace{-15.25ex}\chapter*{#1}}
