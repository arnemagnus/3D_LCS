...
%\tikzset{external/system call={pdflatex \tikzexternalcheckshellescape -halt-on-error -interaction=nonstopmode -jobname "\image" "\texsource"},
%external/optimize=false,
%external/prefix=_tikzcache,
%}
%\tikzexternalize
