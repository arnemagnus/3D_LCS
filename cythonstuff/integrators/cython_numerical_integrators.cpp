...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "cython_numerical_integrators",
        "sources": [
            "cython_numerical_integrators.pyx"
        ]
    },
    "module_name": "cython_numerical_integrators"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cython_numerical_integrators
#define __PYX_HAVE_API__cython_numerical_integrators
#include <string.h>
#include <stdio.h>
...
/* "cython_numerical_integrators.pyx":15
 ...
 * 
 */
typedef std::vector<double>  __pyx_t_28cython_numerical_integrators_dbl_vec;

/* "cython_numerical_integrators.pyx":18
 * 
 * 
 ...
 */
typedef void (*__pyx_t_28cython_numerical_integrators_rhs_func)(double, __pyx_t_28cython_numerical_integrators_dbl_vec, __pyx_t_28cython_numerical_integrators_dbl_vec &);
...
/* Module declarations from 'cython_numerical_integrators' */
static void __pyx_f_28cython_numerical_integrators__daxpy_(double, __pyx_t_28cython_numerical_integrators_dbl_vec &, __pyx_t_28cython_numerical_integrators_dbl_vec &); /*proto*/
static void __pyx_f_28cython_numerical_integrators_rkdp54_p(double *, __pyx_t_28cython_numerical_integrators_dbl_vec &, double *, __pyx_t_28cython_numerical_integrators_rhs_func); /*proto*/
static void __pyx_f_28cython_numerical_integrators_func(double, __pyx_t_28cython_numerical_integrators_dbl_vec, __pyx_t_28cython_numerical_integrators_dbl_vec &); /*proto*/
static void __pyx_f_28cython_numerical_integrators__estimate_e_and_pi_(double, double *); /*proto*/
#define __Pyx_MODULE_NAME "cython_numerical_integrators"
extern int __pyx_module_is_main_cython_numerical_integrators;
int __pyx_module_is_main_cython_numerical_integrators = 0;

/* Implementation of 'cython_numerical_integrators' */
...
static const char __pyx_k_estimate_e_and_pi[] = "estimate_e_and_pi";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_cython_numerical_integrators[] = "cython_numerical_integrators";
static const char __pyx_k_numpy_core_multiarray_failed_to[] = "numpy.core.multiarray failed to import";
static const char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static const char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static const char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static const char __pyx_k_cython_numerical_integrators_pyx[] = "cython_numerical_integrators.pyx";
...
static PyObject *__pyx_n_s_cython_numerical_integrators;
static PyObject *__pyx_kp_s_cython_numerical_integrators_pyx;
static PyObject *__pyx_n_s_estimate_e_and_pi;
...
static PyObject *__pyx_pf_28cython_numerical_integrators_estimate_e_and_pi(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_h); /* proto */
...
/* "cython_numerical_integrators.pyx":20
 * ctypedef void (*rhs_func)(double, dbl_vec, dbl_vec&)
 * 
 * cdef void _daxpy_(double alpha, dbl_vec &x, dbl_vec &y) nogil:             # <<<<<<<<<<<<<<
 *     " y <- ax + y"
...
static void __pyx_f_28cython_numerical_integrators__daxpy_(double __pyx_v_alpha, __pyx_t_28cython_numerical_integrators_dbl_vec &__pyx_v_x, __pyx_t_28cython_numerical_integrators_dbl_vec &__pyx_v_y) {
  int __pyx_v_N;
  int __pyx_v_INCX;
  int __pyx_v_INCY;

  /* "cython_numerical_integrators.pyx":23
 *     " y <- ax + y"
 *     cdef:
 *         int N = x.size()             # <<<<<<<<<<<<<<
 *         int INCX = 1, INCY = 1
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":24
 *     cdef:
 *         int N = x.size()
 *         int INCX = 1, INCY = 1             # <<<<<<<<<<<<<<
 *     cy_daxpy(&N,
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":25
 *         int N = x.size()
 *         int INCX = 1, INCY = 1
 *     cy_daxpy(&N,             # <<<<<<<<<<<<<<
 *              &alpha,
...
/* "cython_numerical_integrators.pyx":33
 * 
 * 
...
static void __pyx_f_28cython_numerical_integrators_rk3_p(double *__pyx_v_t, __pyx_t_28cython_numerical_integrators_dbl_vec &__pyx_v_x, double *__pyx_v_h, __pyx_t_28cython_numerical_integrators_rhs_func __pyx_v_f) {
  int __pyx_v_ndim;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k1;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k2;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k3;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_tmp;
  int __pyx_v_i;
  __Pyx_RefNannyDeclarations
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("rk3_p", 0);

  /* "cython_numerical_integrators.pyx":35
 * cdef void rk3_p(double *t, dbl_vec &x, double *h, rhs_func f):
 *     cdef:
 *         int ndim = x.size()             # <<<<<<<<<<<<<<
 ...
 *         int i
 */
  __pyx_v_ndim = __pyx_v_x.size();

  /* "cython_numerical_integrators.pyx":39
 *         int i
 * 
 *     k1  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k2  = dbl_vec(ndim)
 ...
 */
  try {
    __pyx_t_1 = __pyx_t_28cython_numerical_integrators_dbl_vec(__pyx_v_ndim);
  } catch(...) {
    __Pyx_CppExn2PyErr();
  ...
  /* "cython_numerical_integrators.pyx":40
 * 
 *     k1  = dbl_vec(ndim)
 *     k2  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k3  = dbl_vec(ndim)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":41
 *     k1  = dbl_vec(ndim)
 *     k2  = dbl_vec(ndim)
 *     k3  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":44
 * 
 * 
 *     f(t[0]           , x  , k1)             # <<<<<<<<<<<<<<
 * 
 *     tmp = dbl_vec(ndim)
 */
  __pyx_v_f((__pyx_v_t[0]), __pyx_v_x, __pyx_v_k1);

  /* "cython_numerical_integrators.pyx":46
 *     f(t[0]           , x  , k1)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":47
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(0.5*h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((0.5 * (__pyx_v_h[0])), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":48
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(0.5*h[0],k1,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(1., __pyx_v_x, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":50
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0] + 0.5*h[0], tmp, k2)             # <<<<<<<<<<<<<<
 * 
 *     tmp = dbl_vec(ndim)
 */
  __pyx_v_f(((__pyx_v_t[0]) + (0.5 * (__pyx_v_h[0]))), __pyx_v_tmp, __pyx_v_k2);

  /* "cython_numerical_integrators.pyx":52
 *     f(t[0] + 0.5*h[0], tmp, k2)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     _daxpy_(-h[0],k1,tmp)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":53
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(-h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(2*h[0],k2,tmp)
 *     _daxpy_(1.,x,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((-(__pyx_v_h[0])), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":54
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(-h[0],k1,tmp)
 *     _daxpy_(2*h[0],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((2.0 * (__pyx_v_h[0])), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":55
 *     _daxpy_(-h[0],k1,tmp)
 *     _daxpy_(2*h[0],k2,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":57
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0] + h[0]    , tmp, k3)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_f(((__pyx_v_t[0]) + (__pyx_v_h[0])), __pyx_v_tmp, __pyx_v_k3);

  /* "cython_numerical_integrators.pyx":68
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cython_numerical_integrators.pyx":69
 * 
 *     for i in range(ndim):
 *         x[i] = x[i] + 0.16666666666666667*(k1[i]+4*k2[i]+k3[i])*h[0]             # <<<<<<<<<<<<<<
 * 
 *     t[0] = t[0] + h[0]
 */
    (__pyx_v_x[__pyx_v_i]) = ((__pyx_v_x[__pyx_v_i]) + ((0.16666666666666667 * (((__pyx_v_k1[__pyx_v_i]) + (4.0 * (__pyx_v_k2[__pyx_v_i]))) + (__pyx_v_k3[__pyx_v_i]))) * (__pyx_v_h[0])));
  }

  /* "cython_numerical_integrators.pyx":71
 *         x[i] = x[i] + 0.16666666666666667*(k1[i]+4*k2[i]+k3[i])*h[0]
 * 
 *     t[0] = t[0] + h[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("cython_numerical_integrators.rk3_p", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "cython_numerical_integrators.pyx":74
 * 
 * 
...
static void __pyx_f_28cython_numerical_integrators_rk4_p(double *__pyx_v_t, __pyx_t_28cython_numerical_integrators_dbl_vec &__pyx_v_x, double *__pyx_v_h, __pyx_t_28cython_numerical_integrators_rhs_func __pyx_v_f) {
  int __pyx_v_ndim;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k1;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k2;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k3;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k4;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_tmp;
  int __pyx_v_i;
  __Pyx_RefNannyDeclarations
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("rk4_p", 0);

  /* "cython_numerical_integrators.pyx":76
 * cdef void rk4_p(double *t, dbl_vec &x, double *h, rhs_func f):
 *     cdef:
 *         int ndim = x.size()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":80
 *         int i
 * 
 *     k1  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k2  = dbl_vec(ndim)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":81
 * 
 *     k1  = dbl_vec(ndim)
 *     k2  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k3  = dbl_vec(ndim)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":82
 *     k1  = dbl_vec(ndim)
 *     k2  = dbl_vec(ndim)
 *     k3  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k4  = dbl_vec(ndim)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":83
 *     k2  = dbl_vec(ndim)
 *     k3  = dbl_vec(ndim)
 *     k4  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":85
 *     k4  = dbl_vec(ndim)
 * 
 *     f(t[0]           , x  , k1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":87
 *     f(t[0]           , x  , k1)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     _daxpy_(0.5*h[0],k1,tmp)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":88
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(0.5*h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":89
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(0.5*h[0],k1,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":91
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0] + 0.5*h[0], tmp, k2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":93
 *     f(t[0] + 0.5*h[0], tmp, k2)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":94
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(0.5*h[0],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((0.5 * (__pyx_v_h[0])), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":95
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(0.5*h[0],k2,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":97
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0] + 0.5*h[0], tmp, k3)             # <<<<<<<<<<<<<<
 * 
 *     tmp = dbl_vec(ndim)
 */
  __pyx_v_f(((__pyx_v_t[0]) + (0.5 * (__pyx_v_h[0]))), __pyx_v_tmp, __pyx_v_k3);

  /* "cython_numerical_integrators.pyx":99
 *     f(t[0] + 0.5*h[0], tmp, k3)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     _daxpy_(h[0],k3,tmp)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":100
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(h[0],k3,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_h[0]), __pyx_v_k3, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":101
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(h[0],k3,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":103
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0] + h[0]    , tmp, k4)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_v_f(((__pyx_v_t[0]) + (__pyx_v_h[0])), __pyx_v_tmp, __pyx_v_k4);

  /* "cython_numerical_integrators.pyx":118
 * #    _daxpy_(0.16666666666666667*h[0],tmp,x)
 * 
 *     for i in range(ndim):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cython_numerical_integrators.pyx":119
 * 
 *     for i in range(ndim):
 *         x[i] = x[i] + 0.16666666666666667*(k1[i]+2*k2[i]+2*k3[i]+k4[i])*h[0]             # <<<<<<<<<<<<<<
 * 
 *     t[0] = t[0] + h[0]
 */
    (__pyx_v_x[__pyx_v_i]) = ((__pyx_v_x[__pyx_v_i]) + ((0.16666666666666667 * ((((__pyx_v_k1[__pyx_v_i]) + (2.0 * (__pyx_v_k2[__pyx_v_i]))) + (2.0 * (__pyx_v_k3[__pyx_v_i]))) + (__pyx_v_k4[__pyx_v_i]))) * (__pyx_v_h[0])));
  }

  /* "cython_numerical_integrators.pyx":121
 *         x[i] = x[i] + 0.16666666666666667*(k1[i]+2*k2[i]+2*k3[i]+k4[i])*h[0]
 * 
 *     t[0] = t[0] + h[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("cython_numerical_integrators.rk4_p", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "cython_numerical_integrators.pyx":123
 *     t[0] = t[0] + h[0]
 * 
 * cdef void rkdp54_p(double *t, dbl_vec &x, double *h, rhs_func f):             # <<<<<<<<<<<<<<
 *     cdef:
...
static void __pyx_f_28cython_numerical_integrators_rkdp54_p(double *__pyx_v_t, __pyx_t_28cython_numerical_integrators_dbl_vec &__pyx_v_x, double *__pyx_v_h, __pyx_t_28cython_numerical_integrators_rhs_func __pyx_v_f) {
  int __pyx_v_ndim;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k1;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k2;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k3;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k4;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k5;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k6;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_k7;
  double __pyx_v_c[6];
  double __pyx_v_a1[1];
  double __pyx_v_a2[2];
  double __pyx_v_a3[3];
  ...
  double __pyx_v_b4[7];
  double __pyx_v_b5[7];
  double __pyx_v_h_opt;
  double __pyx_v_err;
  double __pyx_v_sc;
  double __pyx_v_q;
  double __pyx_v_err_tmp;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_tmp;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_x4;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_x5;
  double __pyx_v_atol;
  double __pyx_v_rtol;
  int __pyx_v_i;
  double __pyx_v_fac;
  double __pyx_v_maxfac;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1[6];
  double __pyx_t_2[1];
  double __pyx_t_3[2];
  ...
  double __pyx_t_8[7];
  double __pyx_t_9[7];
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_t_10;
  int __pyx_t_11;
  int __pyx_t_12;
  int __pyx_t_13;
  double __pyx_t_14;
  __Pyx_RefNannySetupContext("rkdp54_p", 0);

  /* "cython_numerical_integrators.pyx":125
 * cdef void rkdp54_p(double *t, dbl_vec &x, double *h, rhs_func f):
 *     cdef:
 *         int ndim = x.size()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":143
 *         double fac, maxfac
 * 
 *     fac = 0.8             # <<<<<<<<<<<<<<
 *     maxfac = 2.
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":144
 * 
 *     fac = 0.8
 *     maxfac = 2.             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":146
 *     maxfac = 2.
 * 
 *     atol = 1e-5             # <<<<<<<<<<<<<<
 *     rtol = 1e-7
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":147
 * 
 *     atol = 1e-5
 *     rtol = 1e-7             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":149
 *     rtol = 1e-7
 * 
 *     c  = [       1./5., \             # <<<<<<<<<<<<<<
 *                               3./10., \
 ...
 */
  ...
  __pyx_t_1[4] = 1.;
  __pyx_t_1[5] = 1.;
  memcpy(&(__pyx_v_c[0]), __pyx_t_1, sizeof(__pyx_v_c[0]) * (6));

  /* "cython_numerical_integrators.pyx":155
 *                                                                               1., \
 *                                                                                           1.]
 *     a1 = [       1./5.                                                                      ]             # <<<<<<<<<<<<<<
 *     a2 = [      3./40.,        9./40.                                                       ]
 ...
 */
  __pyx_t_2[0] = (1. / 5.);
  memcpy(&(__pyx_v_a1[0]), __pyx_t_2, sizeof(__pyx_v_a1[0]) * (1));

  /* "cython_numerical_integrators.pyx":156
 *                                                                                           1.]
 *     a1 = [       1./5.                                                                      ]
 *     a2 = [      3./40.,        9./40.                                                       ]             # <<<<<<<<<<<<<<
 *     a3 = [     44./45.,      -56./15.,       32./9.                                         ]
 ...
 */
  __pyx_t_3[0] = (3. / 40.);
  __pyx_t_3[1] = (9. / 40.);
  memcpy(&(__pyx_v_a2[0]), __pyx_t_3, sizeof(__pyx_v_a2[0]) * (2));

  /* "cython_numerical_integrators.pyx":157
 *     a1 = [       1./5.                                                                      ]
 *     a2 = [      3./40.,        9./40.                                                       ]
 *     a3 = [     44./45.,      -56./15.,       32./9.                                         ]             # <<<<<<<<<<<<<<
 *     a4 = [19372./6561., -25360./2187., 64448./6561., -212./729.                             ]
 ...
 */
  ...
  __pyx_t_4[1] = (-56. / 15.);
  __pyx_t_4[2] = (32. / 9.);
  memcpy(&(__pyx_v_a3[0]), __pyx_t_4, sizeof(__pyx_v_a3[0]) * (3));

  /* "cython_numerical_integrators.pyx":158
 *     a2 = [      3./40.,        9./40.                                                       ]
 *     a3 = [     44./45.,      -56./15.,       32./9.                                         ]
 *     a4 = [19372./6561., -25360./2187., 64448./6561., -212./729.                             ]             # <<<<<<<<<<<<<<
 *     a5 = [ 9017./3168.,     -355./33., 46732./5247.,   49./176.,  -5103./18656.             ]
 ...
 */
  __pyx_t_5[0] = (19372. / 6561.);
  __pyx_t_5[1] = (-25360. / 2187.);
  __pyx_t_5[2] = (64448. / 6561.);
  __pyx_t_5[3] = (-212. / 729.);
  memcpy(&(__pyx_v_a4[0]), __pyx_t_5, sizeof(__pyx_v_a4[0]) * (4));

  /* "cython_numerical_integrators.pyx":159
 *     a3 = [     44./45.,      -56./15.,       32./9.                                         ]
 *     a4 = [19372./6561., -25360./2187., 64448./6561., -212./729.                             ]
 *     a5 = [ 9017./3168.,     -355./33., 46732./5247.,   49./176.,  -5103./18656.             ]             # <<<<<<<<<<<<<<
 *     a6 = [    35./384.,            0.,   500./1113.,  125./192.,    -2187./6784.,    11./84.]
 * 
 */
  __pyx_t_6[0] = (9017. / 3168.);
  __pyx_t_6[1] = (-355. / 33.);
  __pyx_t_6[2] = (46732. / 5247.);
  __pyx_t_6[3] = (49. / 176.);
  __pyx_t_6[4] = (-5103. / 18656.);
  memcpy(&(__pyx_v_a5[0]), __pyx_t_6, sizeof(__pyx_v_a5[0]) * (5));

  /* "cython_numerical_integrators.pyx":160
 *     a4 = [19372./6561., -25360./2187., 64448./6561., -212./729.                             ]
 *     a5 = [ 9017./3168.,     -355./33., 46732./5247.,   49./176.,  -5103./18656.             ]
 *     a6 = [    35./384.,            0.,   500./1113.,  125./192.,    -2187./6784.,    11./84.]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7[0] = (35. / 384.);
  __pyx_t_7[1] = 0.;
  __pyx_t_7[2] = (500. / 1113.);
  __pyx_t_7[3] = (125. / 192.);
  __pyx_t_7[4] = (-2187. / 6784.);
  __pyx_t_7[5] = (11. / 84.);
  memcpy(&(__pyx_v_a6[0]), __pyx_t_7, sizeof(__pyx_v_a6[0]) * (6));

  /* "cython_numerical_integrators.pyx":162
 *     a6 = [    35./384.,            0.,   500./1113.,  125./192.,    -2187./6784.,    11./84.]
 * 
 *     b4 = [5179./57600.,            0., 7571./16695.,  393./640., -92097./339200., 187./2100., 1./40.]             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_8[0] = (5179. / 57600.);
  __pyx_t_8[1] = 0.;
  __pyx_t_8[2] = (7571. / 16695.);
  __pyx_t_8[3] = (393. / 640.);
  __pyx_t_8[4] = (-92097. / 339200.);
  __pyx_t_8[5] = (187. / 2100.);
  __pyx_t_8[6] = (1. / 40.);
  memcpy(&(__pyx_v_b4[0]), __pyx_t_8, sizeof(__pyx_v_b4[0]) * (7));

  /* "cython_numerical_integrators.pyx":163
 * 
 *     b4 = [5179./57600.,            0., 7571./16695.,  393./640., -92097./339200., 187./2100., 1./40.]
 *     b5 = [    35./384.,            0.,   500./1113.,  125./192.,    -2187./6784.,    11./84.,     0.]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_9[0] = (35. / 384.);
  __pyx_t_9[1] = 0.;
  __pyx_t_9[2] = (500. / 1113.);
  __pyx_t_9[3] = (125. / 192.);
  __pyx_t_9[4] = (-2187. / 6784.);
  __pyx_t_9[5] = (11. / 84.);
  __pyx_t_9[6] = 0.;
  memcpy(&(__pyx_v_b5[0]), __pyx_t_9, sizeof(__pyx_v_b5[0]) * (7));

  /* "cython_numerical_integrators.pyx":165
 *     b5 = [    35./384.,            0.,   500./1113.,  125./192.,    -2187./6784.,    11./84.,     0.]
 * 
 *     k1 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k2 = dbl_vec(ndim)
 ...
 */
  try {
    __pyx_t_10 = __pyx_t_28cython_numerical_integrators_dbl_vec(__pyx_v_ndim);
  } catch(...) {
    __Pyx_CppExn2PyErr();
  ...
  /* "cython_numerical_integrators.pyx":166
 * 
 *     k1 = dbl_vec(ndim)
 *     k2 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k3 = dbl_vec(ndim)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":167
 *     k1 = dbl_vec(ndim)
 *     k2 = dbl_vec(ndim)
 *     k3 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k4 = dbl_vec(ndim)
 ...
 */
  ...
  __pyx_v_k3 = __pyx_t_10;

  /* "cython_numerical_integrators.pyx":168
 *     k2 = dbl_vec(ndim)
 *     k3 = dbl_vec(ndim)
 *     k4 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k5 = dbl_vec(ndim)
 ...
 */
  ...
  __pyx_v_k4 = __pyx_t_10;

  /* "cython_numerical_integrators.pyx":169
 *     k3 = dbl_vec(ndim)
 *     k4 = dbl_vec(ndim)
 *     k5 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k6 = dbl_vec(ndim)
 ...
 */
  ...
  __pyx_v_k5 = __pyx_t_10;

  /* "cython_numerical_integrators.pyx":170
 *     k4 = dbl_vec(ndim)
 *     k5 = dbl_vec(ndim)
 *     k6 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k7 = dbl_vec(ndim)
 ...
 */
  ...
  __pyx_v_k6 = __pyx_t_10;

  /* "cython_numerical_integrators.pyx":171
 *     k5 = dbl_vec(ndim)
 *     k6 = dbl_vec(ndim)
 *     k7 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_v_k7 = __pyx_t_10;

  /* "cython_numerical_integrators.pyx":173
 *     k7 = dbl_vec(ndim)
 * 
 *     f(t[0], x, k1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":175
 *     f(t[0], x, k1)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":176
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a1[0]*h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a1[0]) * (__pyx_v_h[0])), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":177
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a1[0]*h[0],k1,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":179
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0] + c[0]*h[0], tmp, k2)             # <<<<<<<<<<<<<<
 * 
 *     tmp = dbl_vec(ndim)
 */
  __pyx_v_f(((__pyx_v_t[0]) + ((__pyx_v_c[0]) * (__pyx_v_h[0]))), __pyx_v_tmp, __pyx_v_k2);

  /* "cython_numerical_integrators.pyx":181
 *     f(t[0] + c[0]*h[0], tmp, k2)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":182
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a2[0]*h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a2[1]*h[0],k2,tmp)
 *     _daxpy_(1.,x,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a2[0]) * (__pyx_v_h[0])), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":183
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a2[0]*h[0],k1,tmp)
 *     _daxpy_(a2[1]*h[0],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a2[1]) * (__pyx_v_h[0])), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":184
 *     _daxpy_(a2[0]*h[0],k1,tmp)
 *     _daxpy_(a2[1]*h[0],k2,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":186
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0] + c[1]*h[0], tmp, k3)             # <<<<<<<<<<<<<<
 * 
 *     tmp = dbl_vec(ndim)
 */
  __pyx_v_f(((__pyx_v_t[0]) + ((__pyx_v_c[1]) * (__pyx_v_h[0]))), __pyx_v_tmp, __pyx_v_k3);

  /* "cython_numerical_integrators.pyx":188
 *     f(t[0] + c[1]*h[0], tmp, k3)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":189
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a3[0]*h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a3[1]*h[0],k2,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a3[0]) * (__pyx_v_h[0])), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":190
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a3[0]*h[0],k1,tmp)
 *     _daxpy_(a3[1]*h[0],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a3[2]*h[0],k3,tmp)
 *     _daxpy_(1.,x,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a3[1]) * (__pyx_v_h[0])), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":191
 *     _daxpy_(a3[0]*h[0],k1,tmp)
 *     _daxpy_(a3[1]*h[0],k2,tmp)
 *     _daxpy_(a3[2]*h[0],k3,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a3[2]) * (__pyx_v_h[0])), __pyx_v_k3, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":192
 *     _daxpy_(a3[1]*h[0],k2,tmp)
 *     _daxpy_(a3[2]*h[0],k3,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":194
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0]+c[2]*h[0], tmp, k4)             # <<<<<<<<<<<<<<
 * 
 *     tmp = dbl_vec(ndim)
 */
  __pyx_v_f(((__pyx_v_t[0]) + ((__pyx_v_c[2]) * (__pyx_v_h[0]))), __pyx_v_tmp, __pyx_v_k4);

  /* "cython_numerical_integrators.pyx":196
 *     f(t[0]+c[2]*h[0], tmp, k4)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":197
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a4[0]*h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a4[1]*h[0],k2,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a4[0]) * (__pyx_v_h[0])), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":198
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a4[0]*h[0],k1,tmp)
 *     _daxpy_(a4[1]*h[0],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a4[2]*h[0],k3,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a4[1]) * (__pyx_v_h[0])), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":199
 *     _daxpy_(a4[0]*h[0],k1,tmp)
 *     _daxpy_(a4[1]*h[0],k2,tmp)
 *     _daxpy_(a4[2]*h[0],k3,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a4[3]*h[0],k4,tmp)
 *     _daxpy_(1.,x,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a4[2]) * (__pyx_v_h[0])), __pyx_v_k3, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":200
 *     _daxpy_(a4[1]*h[0],k2,tmp)
 *     _daxpy_(a4[2]*h[0],k3,tmp)
 *     _daxpy_(a4[3]*h[0],k4,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a4[3]) * (__pyx_v_h[0])), __pyx_v_k4, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":201
 *     _daxpy_(a4[2]*h[0],k3,tmp)
 *     _daxpy_(a4[3]*h[0],k4,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":204
 * 
 * 
 ...
 *     tmp = dbl_vec(ndim)
 */
  __pyx_v_f(((__pyx_v_t[0]) + ((__pyx_v_c[3]) * (__pyx_v_h[0]))), __pyx_v_tmp, __pyx_v_k5);

  /* "cython_numerical_integrators.pyx":206
 *     f(t[0]+c[3]*h[0], tmp, k5)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":207
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a5[0]*h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a5[1]*h[0],k2,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a5[0]) * (__pyx_v_h[0])), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":208
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a5[0]*h[0],k1,tmp)
 *     _daxpy_(a5[1]*h[0],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a5[2]*h[0],k3,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a5[1]) * (__pyx_v_h[0])), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":209
 *     _daxpy_(a5[0]*h[0],k1,tmp)
 *     _daxpy_(a5[1]*h[0],k2,tmp)
 *     _daxpy_(a5[2]*h[0],k3,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a5[3]*h[0],k4,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a5[2]) * (__pyx_v_h[0])), __pyx_v_k3, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":210
 *     _daxpy_(a5[1]*h[0],k2,tmp)
 *     _daxpy_(a5[2]*h[0],k3,tmp)
 *     _daxpy_(a5[3]*h[0],k4,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a5[4]*h[0],k5,tmp)
 *     _daxpy_(1.,x,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a5[3]) * (__pyx_v_h[0])), __pyx_v_k4, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":211
 *     _daxpy_(a5[2]*h[0],k3,tmp)
 *     _daxpy_(a5[3]*h[0],k4,tmp)
 *     _daxpy_(a5[4]*h[0],k5,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(1.,x,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a5[4]) * (__pyx_v_h[0])), __pyx_v_k5, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":212
 *     _daxpy_(a5[3]*h[0],k4,tmp)
 *     _daxpy_(a5[4]*h[0],k5,tmp)
 *     _daxpy_(1.,x,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":214
 *     _daxpy_(1.,x,tmp)
 * 
 *     f(t[0]+c[4]*h[0], tmp, k6)             # <<<<<<<<<<<<<<
 * 
 *     tmp = dbl_vec(ndim)
 */
  __pyx_v_f(((__pyx_v_t[0]) + ((__pyx_v_c[4]) * (__pyx_v_h[0]))), __pyx_v_tmp, __pyx_v_k6);

  /* "cython_numerical_integrators.pyx":216
 *     f(t[0]+c[4]*h[0], tmp, k6)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":217
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a6[0]*h[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a6[1]*h[0],k2,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a6[0]) * (__pyx_v_h[0])), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":218
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(a6[0]*h[0],k1,tmp)
 *     _daxpy_(a6[1]*h[0],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a6[2]*h[0],k3,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a6[1]) * (__pyx_v_h[0])), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":219
 *     _daxpy_(a6[0]*h[0],k1,tmp)
 *     _daxpy_(a6[1]*h[0],k2,tmp)
 *     _daxpy_(a6[2]*h[0],k3,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a6[3]*h[0],k4,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a6[2]) * (__pyx_v_h[0])), __pyx_v_k3, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":220
 *     _daxpy_(a6[1]*h[0],k2,tmp)
 *     _daxpy_(a6[2]*h[0],k3,tmp)
 *     _daxpy_(a6[3]*h[0],k4,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a6[4]*h[0],k5,tmp)
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a6[3]) * (__pyx_v_h[0])), __pyx_v_k4, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":221
 *     _daxpy_(a6[2]*h[0],k3,tmp)
 *     _daxpy_(a6[3]*h[0],k4,tmp)
 *     _daxpy_(a6[4]*h[0],k5,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(a6[5]*h[0],k6,tmp)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a6[4]) * (__pyx_v_h[0])), __pyx_v_k5, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":222
 *     _daxpy_(a6[3]*h[0],k4,tmp)
 *     _daxpy_(a6[4]*h[0],k5,tmp)
 *     _daxpy_(a6[5]*h[0],k6,tmp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_f_28cython_numerical_integrators__daxpy_(((__pyx_v_a6[5]) * (__pyx_v_h[0])), __pyx_v_k6, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":224
 *     _daxpy_(a6[5]*h[0],k6,tmp)
 * 
 *     f(t[0]+c[5]*h[0], tmp, k7)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_v_f(((__pyx_v_t[0]) + ((__pyx_v_c[5]) * (__pyx_v_h[0]))), __pyx_v_tmp, __pyx_v_k7);

  /* "cython_numerical_integrators.pyx":227
 * 
 * 
 *     x5 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     x4 = dbl_vec(ndim)
 ...
 */
  ...
  __pyx_v_x5 = __pyx_t_10;

  /* "cython_numerical_integrators.pyx":228
 * 
 *     x5 = dbl_vec(ndim)
 *     x4 = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_v_x4 = __pyx_t_10;

  /* "cython_numerical_integrators.pyx":230
 *     x4 = dbl_vec(ndim)
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     _daxpy_(b4[0],k1,tmp)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":231
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(b4[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b4[1],k2,tmp)
 *     _daxpy_(b4[2],k3,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b4[0]), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":232
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(b4[0],k1,tmp)
 *     _daxpy_(b4[1],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b4[2],k3,tmp)
 *     _daxpy_(b4[3],k4,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b4[1]), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":233
 *     _daxpy_(b4[0],k1,tmp)
 *     _daxpy_(b4[1],k2,tmp)
 *     _daxpy_(b4[2],k3,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b4[3],k4,tmp)
 *     _daxpy_(b4[4],k5,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b4[2]), __pyx_v_k3, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":234
 *     _daxpy_(b4[1],k2,tmp)
 *     _daxpy_(b4[2],k3,tmp)
 *     _daxpy_(b4[3],k4,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b4[4],k5,tmp)
 *     _daxpy_(b4[5],k6,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b4[3]), __pyx_v_k4, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":235
 *     _daxpy_(b4[2],k3,tmp)
 *     _daxpy_(b4[3],k4,tmp)
 *     _daxpy_(b4[4],k5,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b4[5],k6,tmp)
 *     _daxpy_(b4[6],k7,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b4[4]), __pyx_v_k5, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":236
 *     _daxpy_(b4[3],k4,tmp)
 *     _daxpy_(b4[4],k5,tmp)
 *     _daxpy_(b4[5],k6,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b4[6],k7,tmp)
 *     _daxpy_(h[0],tmp,x4)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b4[5]), __pyx_v_k6, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":237
 *     _daxpy_(b4[4],k5,tmp)
 *     _daxpy_(b4[5],k6,tmp)
 *     _daxpy_(b4[6],k7,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(h[0],tmp,x4)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b4[6]), __pyx_v_k7, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":238
 *     _daxpy_(b4[5],k6,tmp)
 *     _daxpy_(b4[6],k7,tmp)
 *     _daxpy_(h[0],tmp,x4)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_h[0]), __pyx_v_tmp, __pyx_v_x4);

  /* "cython_numerical_integrators.pyx":241
 * 
 * 
 *     tmp = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     _daxpy_(b5[0],k1,tmp)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":242
 * 
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(b5[0],k1,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b5[1],k2,tmp)
 *     _daxpy_(b5[2],k3,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b5[0]), __pyx_v_k1, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":243
 *     tmp = dbl_vec(ndim)
 *     _daxpy_(b5[0],k1,tmp)
 *     _daxpy_(b5[1],k2,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b5[2],k3,tmp)
 *     _daxpy_(b5[3],k4,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b5[1]), __pyx_v_k2, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":244
 *     _daxpy_(b5[0],k1,tmp)
 *     _daxpy_(b5[1],k2,tmp)
 *     _daxpy_(b5[2],k3,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b5[3],k4,tmp)
 *     _daxpy_(b5[4],k5,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b5[2]), __pyx_v_k3, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":245
 *     _daxpy_(b5[1],k2,tmp)
 *     _daxpy_(b5[2],k3,tmp)
 *     _daxpy_(b5[3],k4,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b5[4],k5,tmp)
 *     _daxpy_(b5[5],k6,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b5[3]), __pyx_v_k4, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":246
 *     _daxpy_(b5[2],k3,tmp)
 *     _daxpy_(b5[3],k4,tmp)
 *     _daxpy_(b5[4],k5,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b5[5],k6,tmp)
 *     _daxpy_(b5[6],k7,tmp)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b5[4]), __pyx_v_k5, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":247
 *     _daxpy_(b5[3],k4,tmp)
 *     _daxpy_(b5[4],k5,tmp)
 *     _daxpy_(b5[5],k6,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(b5[6],k7,tmp)
 *     _daxpy_(h[0],tmp,x5)
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b5[5]), __pyx_v_k6, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":248
 *     _daxpy_(b5[4],k5,tmp)
 *     _daxpy_(b5[5],k6,tmp)
 *     _daxpy_(b5[6],k7,tmp)             # <<<<<<<<<<<<<<
 *     _daxpy_(h[0],tmp,x5)
 * 
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_b5[6]), __pyx_v_k7, __pyx_v_tmp);

  /* "cython_numerical_integrators.pyx":249
 *     _daxpy_(b5[5],k6,tmp)
 *     _daxpy_(b5[6],k7,tmp)
 *     _daxpy_(h[0],tmp,x5)             # <<<<<<<<<<<<<<
 * 
 *     q = 4.
 */
  __pyx_f_28cython_numerical_integrators__daxpy_((__pyx_v_h[0]), __pyx_v_tmp, __pyx_v_x5);

  /* "cython_numerical_integrators.pyx":251
 *     _daxpy_(h[0],tmp,x5)
 * 
 *     q = 4.             # <<<<<<<<<<<<<<
 *     err = 0.
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":252
 * 
 *     q = 4.
 *     err = 0.             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":254
 *     err = 0.
 * 
 *     for i in range(ndim):             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_11 = __pyx_v_ndim;
  for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
    __pyx_v_i = __pyx_t_12;

    /* "cython_numerical_integrators.pyx":255
 * 
 *     for i in range(ndim):
 *         if cy_fabs(x4[i]) > cy_fabs(x5[i]):             # <<<<<<<<<<<<<<
 *             sc = atol + cy_fabs(x4[i])*rtol
 *         else:
 */
    __pyx_t_13 = ((fabs((__pyx_v_x4[__pyx_v_i])) > fabs((__pyx_v_x5[__pyx_v_i]))) != 0);
    if (__pyx_t_13) {

      /* "cython_numerical_integrators.pyx":256
 *     for i in range(ndim):
 *         if cy_fabs(x4[i]) > cy_fabs(x5[i]):
 *             sc = atol + cy_fabs(x4[i])*rtol             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_v_sc = (__pyx_v_atol + (fabs((__pyx_v_x4[__pyx_v_i])) * __pyx_v_rtol));
 ...
 */
    ...
    /* "cython_numerical_integrators.pyx":258
 *             sc = atol + cy_fabs(x4[i])*rtol
 *         else:
 *             sc = atol + cy_fabs(x5[i])*rtol             # <<<<<<<<<<<<<<
 ...
 */
    /*else*/ {
      __pyx_v_sc = (__pyx_v_atol + (fabs((__pyx_v_x5[__pyx_v_i])) * __pyx_v_rtol));
    }
    __pyx_L5:;

    /* "cython_numerical_integrators.pyx":259
 *         else:
 *             sc = atol + cy_fabs(x5[i])*rtol
 *         err_tmp = cy_fabs(x4[i]-x5[i])/sc             # <<<<<<<<<<<<<<
 *         if err_tmp > err:
 *             err = err_tmp
 */
    __pyx_t_14 = fabs(((__pyx_v_x4[__pyx_v_i]) - (__pyx_v_x5[__pyx_v_i])));
    if (unlikely(__pyx_v_sc == 0)) {
      PyErr_SetString(PyExc_ZeroDivisionError, "float division");
      __PYX_ERR(0, 259, __pyx_L1_error)
    }
    __pyx_v_err_tmp = (__pyx_t_14 / __pyx_v_sc);

    /* "cython_numerical_integrators.pyx":260
 *             sc = atol + cy_fabs(x5[i])*rtol
 *         err_tmp = cy_fabs(x4[i]-x5[i])/sc
 *         if err_tmp > err:             # <<<<<<<<<<<<<<
 *             err = err_tmp
 * 
 */
    __pyx_t_13 = ((__pyx_v_err_tmp > __pyx_v_err) != 0);
    if (__pyx_t_13) {

      /* "cython_numerical_integrators.pyx":261
 *         err_tmp = cy_fabs(x4[i]-x5[i])/sc
 *         if err_tmp > err:
 *             err = err_tmp             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":264
 * 
 * 
 *     if err == 0:             # <<<<<<<<<<<<<<
 ...
 *     else:
 */
  __pyx_t_13 = ((__pyx_v_err == 0.0) != 0);
  if (__pyx_t_13) {

    /* "cython_numerical_integrators.pyx":265
 * 
 *     if err == 0:
 *         h_opt = cy_copysign(10, h[0])             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __pyx_v_h_opt = copysign(10.0, (__pyx_v_h[0]));
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":267
 *         h_opt = cy_copysign(10, h[0])
 *     else:
 *         h_opt = h[0]*cy_pow(1./err, 1./(q+1.))             # <<<<<<<<<<<<<<
 *     if err > 1:
 ...
 */
  /*else*/ {
    ...
    __pyx_v_h_opt = ((__pyx_v_h[0]) * pow((1. / __pyx_v_err), (1. / __pyx_t_14)));
  }
  __pyx_L7:;

  /* "cython_numerical_integrators.pyx":268
 *     else:
 *         h_opt = h[0]*cy_pow(1./err, 1./(q+1.))
 *     if err > 1:             # <<<<<<<<<<<<<<
 *         h[0] = fac * h_opt
 *     else:
 */
  __pyx_t_13 = ((__pyx_v_err > 1.0) != 0);
  if (__pyx_t_13) {

    /* "cython_numerical_integrators.pyx":269
 *         h_opt = h[0]*cy_pow(1./err, 1./(q+1.))
 *     if err > 1:
 *         h[0] = fac * h_opt             # <<<<<<<<<<<<<<
 *     else:
 *         t[0] = t[0] + h[0]
 */
    (__pyx_v_h[0]) = (__pyx_v_fac * __pyx_v_h_opt);
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":271
 *         h[0] = fac * h_opt
 *     else:
 *         t[0] = t[0] + h[0]             # <<<<<<<<<<<<<<
 *         _daxpy_(1.,x5,x)
 ...
 */
  /*else*/ {
    ...
    /* "cython_numerical_integrators.pyx":272
 *     else:
 *         t[0] = t[0] + h[0]
 *         _daxpy_(1.,x5,x)             # <<<<<<<<<<<<<<
 *         if maxfac*h[0] > fac*h_opt:
 *             h[0] = maxfac*h[0]
 */
    __pyx_f_28cython_numerical_integrators__daxpy_(1., __pyx_v_x5, __pyx_v_x);

    /* "cython_numerical_integrators.pyx":273
 *         t[0] = t[0] + h[0]
 *         _daxpy_(1.,x5,x)
 *         if maxfac*h[0] > fac*h_opt:             # <<<<<<<<<<<<<<
 *             h[0] = maxfac*h[0]
 *         else:
 */
    __pyx_t_13 = (((__pyx_v_maxfac * (__pyx_v_h[0])) > (__pyx_v_fac * __pyx_v_h_opt)) != 0);
    if (__pyx_t_13) {

      /* "cython_numerical_integrators.pyx":274
 *         _daxpy_(1.,x5,x)
 *         if maxfac*h[0] > fac*h_opt:
 *             h[0] = maxfac*h[0]             # <<<<<<<<<<<<<<
 *         else:
 *             h[0] = fac*h_opt
 */
      (__pyx_v_h[0]) = (__pyx_v_maxfac * (__pyx_v_h[0]));
 ...
 */
    ...
    /* "cython_numerical_integrators.pyx":276
 *             h[0] = maxfac*h[0]
 *         else:
 *             h[0] = fac*h_opt             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("cython_numerical_integrators.rkdp54_p", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "cython_numerical_integrators.pyx":281
 * 
...
static void __pyx_f_28cython_numerical_integrators_func(double __pyx_v_t, __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_x, __pyx_t_28cython_numerical_integrators_dbl_vec &__pyx_v_ret) {

  /* "cython_numerical_integrators.pyx":286
 * 
 ...
 *     ret[2] = x[2]
 */
  (__pyx_v_ret[0]) = (__pyx_v_x[0]);

  /* "cython_numerical_integrators.pyx":287
 *     #assert ret.size() == x.size()
 *     ret[0] = x[0]
 *     ret[1] = 1./(1+cy_pow(t,2))             # <<<<<<<<<<<<<<
 *     ret[2] = x[2]
 * 
 */
  (__pyx_v_ret[1]) = (1. / (1.0 + pow(__pyx_v_t, 2.0)));

  /* "cython_numerical_integrators.pyx":288
 *     ret[0] = x[0]
 *     ret[1] = 1./(1+cy_pow(t,2))
 *     ret[2] = x[2]             # <<<<<<<<<<<<<<
 * 
...
/* "cython_numerical_integrators.pyx":291
 * 
 * @cython.cdivision(True)
...
static void __pyx_f_28cython_numerical_integrators__estimate_e_and_pi_(double __pyx_v_h, double *__pyx_v_r) {
  double __pyx_v_t0;
  double __pyx_v_tf;
  double __pyx_v_t;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_ret;
  __Pyx_RefNannyDeclarations
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_t_1;
  int __pyx_t_2;
  __Pyx_RefNannySetupContext("_estimate_e_and_pi_", 0);

  /* "cython_numerical_integrators.pyx":297
 *         dbl_vec ret
 *         int i, niter
 *     ret = dbl_vec(3)             # <<<<<<<<<<<<<<
 *     t0 = 0.
 ...
 */
  try {
    __pyx_t_1 = __pyx_t_28cython_numerical_integrators_dbl_vec(3);
  } catch(...) {
    __Pyx_CppExn2PyErr();
  ...
  /* "cython_numerical_integrators.pyx":298
 *         int i, niter
 *     ret = dbl_vec(3)
 *     t0 = 0.             # <<<<<<<<<<<<<<
 *     tf = 1.
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":299
 *     ret = dbl_vec(3)
 *     t0 = 0.
 *     tf = 1.             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":301
 *     tf = 1.
 * 
 *     ret[0] = 1             # <<<<<<<<<<<<<<
 *     ret[2] = 1
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":302
 * 
 *     ret[0] = 1
 *     ret[2] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":306
 * #    niter = int(cy_ceil((tf-t0)/h))
 * 
 *     t = t0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":308
 *     t = t0
 * 
 *     while t < tf:             # <<<<<<<<<<<<<<
 *         if h > tf - t:
 ...
 */
  while (1) {
    __pyx_t_2 = ((__pyx_v_t < __pyx_v_tf) != 0);
    if (!__pyx_t_2) break;

    /* "cython_numerical_integrators.pyx":309
 * 
 *     while t < tf:
 *         if h > tf - t:             # <<<<<<<<<<<<<<
 *             h = tf - t
 ...
 */
    __pyx_t_2 = ((__pyx_v_h > (__pyx_v_tf - __pyx_v_t)) != 0);
    if (__pyx_t_2) {

      /* "cython_numerical_integrators.pyx":310
 *     while t < tf:
 *         if h > tf - t:
 *             h = tf - t             # <<<<<<<<<<<<<<
 *         rkdp54_p(&t, ret, &h, func)
 ...
 */
    ...
    /* "cython_numerical_integrators.pyx":311
 *         if h > tf - t:
 *             h = tf - t
 *         rkdp54_p(&t, ret, &h, func)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_f_28cython_numerical_integrators_rkdp54_p((&__pyx_v_t), __pyx_v_ret, (&__pyx_v_h), __pyx_f_28cython_numerical_integrators_func);
  }

  /* "cython_numerical_integrators.pyx":316
 * #        rk3_p(&t, ret, &h, func)
 * 
 *     r[0] = ret[0]             # <<<<<<<<<<<<<<
 *     r[1] = 4*ret[1]
 *     r[2] = ret[2]
 */
  (__pyx_v_r[0]) = (__pyx_v_ret[0]);

  /* "cython_numerical_integrators.pyx":317
 * 
 *     r[0] = ret[0]
 *     r[1] = 4*ret[1]             # <<<<<<<<<<<<<<
 *     r[2] = ret[2]
 * 
 */
  (__pyx_v_r[1]) = (4.0 * (__pyx_v_ret[1]));

  /* "cython_numerical_integrators.pyx":318
 *     r[0] = ret[0]
 *     r[1] = 4*ret[1]
 *     r[2] = ret[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("cython_numerical_integrators._estimate_e_and_pi_", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "cython_numerical_integrators.pyx":325
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_28cython_numerical_integrators_1estimate_e_and_pi(PyObject *__pyx_self, PyObject *__pyx_arg_h); /*proto*/
static PyMethodDef __pyx_mdef_28cython_numerical_integrators_1estimate_e_and_pi = {"estimate_e_and_pi", (PyCFunction)__pyx_pw_28cython_numerical_integrators_1estimate_e_and_pi, METH_O, 0};
static PyObject *__pyx_pw_28cython_numerical_integrators_1estimate_e_and_pi(PyObject *__pyx_self, PyObject *__pyx_arg_h) {
  double __pyx_v_h;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("estimate_e_and_pi (wrapper)", 0);
  assert(__pyx_arg_h); {
    __pyx_v_h = __pyx_PyFloat_AsDouble(__pyx_arg_h); if (unlikely((__pyx_v_h == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 325, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_numerical_integrators.estimate_e_and_pi", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_28cython_numerical_integrators_estimate_e_and_pi(__pyx_self, ((double)__pyx_v_h));
...
static PyObject *__pyx_pf_28cython_numerical_integrators_estimate_e_and_pi(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_h) {
  double __pyx_v_r[3];
  ...
  __Pyx_RefNannySetupContext("estimate_e_and_pi", 0);

  /* "cython_numerical_integrators.pyx":328
 *     cdef:
 *         double r[3]
 *     _estimate_e_and_pi_(h, &r[0])             # <<<<<<<<<<<<<<
 *     return r[0], r[1], r[2]
 */
  __pyx_f_28cython_numerical_integrators__estimate_e_and_pi_(__pyx_v_h, (&(__pyx_v_r[0])));

  /* "cython_numerical_integrators.pyx":329
 *         double r[3]
 *     _estimate_e_and_pi_(h, &r[0])
 *     return r[0], r[1], r[2]             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_r[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 329, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyFloat_FromDouble((__pyx_v_r[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 329, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyFloat_FromDouble((__pyx_v_r[2])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 329, __pyx_L1_error)
...
static int __pyx_pymod_exec_cython_numerical_integrators(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cython_numerical_integrators},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_cython_numerical_integrators, __pyx_k_cython_numerical_integrators, sizeof(__pyx_k_cython_numerical_integrators), 0, 0, 1, 1},
  {&__pyx_kp_s_cython_numerical_integrators_pyx, __pyx_k_cython_numerical_integrators_pyx, sizeof(__pyx_k_cython_numerical_integrators_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_estimate_e_and_pi, __pyx_k_estimate_e_and_pi, sizeof(__pyx_k_estimate_e_and_pi), 0, 0, 1, 1},
 ...
 *         double r[3]
 */
  __pyx_tuple__10 = PyTuple_Pack(3, __pyx_n_s_h, __pyx_n_s_h, __pyx_n_s_r); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 325, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(1, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_numerical_integrators_pyx, __pyx_n_s_estimate_e_and_pi, 325, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 325, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcython_numerical_integrators(void); /*proto*/
PyMODINIT_FUNC initcython_numerical_integrators(void)
#else
PyMODINIT_FUNC PyInit_cython_numerical_integrators(void); /*proto*/
PyMODINIT_FUNC PyInit_cython_numerical_integrators(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_cython_numerical_integrators(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cython_numerical_integrators(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_numerical_integrators", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cython_numerical_integrators) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cython_numerical_integrators")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_numerical_integrators", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cython_numerical_integrators.pyx":2
 * cimport cython
 * import time             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":6
 * 
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 *         double r[3]
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_28cython_numerical_integrators_1estimate_e_and_pi, NULL, __pyx_n_s_cython_numerical_integrators); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 325, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_estimate_e_and_pi, __pyx_t_2) < 0) __PYX_ERR(0, 325, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "cython_numerical_integrators.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * import time
 * from cython.parallel cimport parallel, prange
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_numerical_integrators", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_numerical_integrators");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
