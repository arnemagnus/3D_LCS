...
/* "cython_numerical_integrators.pyx":11
 * 
 * 
...
/* "cython_numerical_integrators.pyx":14
 * 
 * 
 * ctypedef void (*rhs_func)(double, dbl_vec, dbl_vec&)             # <<<<<<<<<<<<<<
 * 
 * cdef dbl_vec add_dbl_vec_elementwise(const dbl_vec &a, const dbl_vec &b):
 */
...
static __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_f_28cython_numerical_integrators_add_dbl_vec_elementwise(__pyx_t_28cython_numerical_integrators_dbl_vec const &, __pyx_t_28cython_numerical_integrators_dbl_vec const &); /*proto*/
static void __pyx_f_28cython_numerical_integrators_rk4_p(double *, __pyx_t_28cython_numerical_integrators_dbl_vec &, double *, __pyx_t_28cython_numerical_integrators_rhs_func); /*proto*/
...
static double __pyx_f_28cython_numerical_integrators_estimate_e(double, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_28cython_numerical_integrators_estimate_e(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_h); /* proto */
...
/* "cython_numerical_integrators.pyx":16
 * ctypedef void (*rhs_func)(double, dbl_vec, dbl_vec&)
 * 
 * cdef dbl_vec add_dbl_vec_elementwise(const dbl_vec &a, const dbl_vec &b):             # <<<<<<<<<<<<<<
 *     cdef:
...
static __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_f_28cython_numerical_integrators_add_dbl_vec_elementwise(__pyx_t_28cython_numerical_integrators_dbl_vec const &__pyx_v_a, __pyx_t_28cython_numerical_integrators_dbl_vec const &__pyx_v_b) {
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_ret;
  int __pyx_v_i;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_r;
  __Pyx_RefNannyDeclarations
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_t_1;
  std::vector<double> ::size_type __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("add_dbl_vec_elementwise", 0);
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    if (unlikely(!((__pyx_v_a.size() == __pyx_v_b.size()) != 0))) {
  ...
  /* "cython_numerical_integrators.pyx":22
 *     assert a.size() == b.size()
 * 
 *     ret = dbl_vec(a.size())             # <<<<<<<<<<<<<<
 ...
 */
  try {
    __pyx_t_1 = __pyx_t_28cython_numerical_integrators_dbl_vec(__pyx_v_a.size());
  } catch(...) {
    __Pyx_CppExn2PyErr();
 ...
 * 
 */
    (__pyx_v_ret[__pyx_v_i]) = ((__pyx_v_a[__pyx_v_i]) + (__pyx_v_b[__pyx_v_i]));
  }
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("cython_numerical_integrators.add_dbl_vec_elementwise", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
...
/* "cython_numerical_integrators.pyx":28
 * 
 * 
...
static void __pyx_f_28cython_numerical_integrators_rk4_p(double *__pyx_v_t, __pyx_t_28cython_numerical_integrators_dbl_vec &__pyx_v_x, double *__pyx_v_h, __pyx_t_28cython_numerical_integrators_rhs_func __pyx_v_f) {
  ...
  /* "cython_numerical_integrators.pyx":30
 * cdef void rk4_p(double *t, dbl_vec &x, double *h, rhs_func f):
 *     cdef:
 *         int ndim = x.size()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":36
 * 
 *     k1  = dbl_vec(ndim)
 *     k2  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k3  = dbl_vec(ndim)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":37
 *     k1  = dbl_vec(ndim)
 *     k2  = dbl_vec(ndim)
 *     k3  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     k4  = dbl_vec(ndim)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":38
 *     k2  = dbl_vec(ndim)
 *     k3  = dbl_vec(ndim)
 *     k4  = dbl_vec(ndim)             # <<<<<<<<<<<<<<
 *     tmp = dbl_vec(ndim)
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":42
 * 
 * 
 *     f(t[0]           , x                              , k1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cython_numerical_integrators.pyx":45
 * 
 *     for i in range(ndim):
 *         tmp[i] = 0.5*h[0]*k1[i]             # <<<<<<<<<<<<<<
 * 
 *     f(t[0] + 0.5*h[0], add_dbl_vec_elementwise(x, tmp), k2)
 */
    (__pyx_v_tmp[__pyx_v_i]) = ((0.5 * (__pyx_v_h[0])) * (__pyx_v_k1[__pyx_v_i]));
  }
 ...
 *     for i in range(ndim):
 */
  __pyx_v_f(((__pyx_v_t[0]) + (0.5 * (__pyx_v_h[0]))), __pyx_f_28cython_numerical_integrators_add_dbl_vec_elementwise(__pyx_v_x, __pyx_v_tmp), __pyx_v_k2);

  /* "cython_numerical_integrators.pyx":49
 *     f(t[0] + 0.5*h[0], add_dbl_vec_elementwise(x, tmp), k2)
 * 
 *     for i in range(ndim):             # <<<<<<<<<<<<<<
 *         tmp[i] = 0.5*h[0]*k2[i]
 ...
 *         tmp[i] = 0.5*h[0]*k2[i]             # <<<<<<<<<<<<<<
 * 
 *     f(t[0] + 0.5*h[0], add_dbl_vec_elementwise(x, tmp), k3)
 */
    (__pyx_v_tmp[__pyx_v_i]) = ((0.5 * (__pyx_v_h[0])) * (__pyx_v_k2[__pyx_v_i]));
  }
 ...
 *     for i in range(ndim):
 */
  __pyx_v_f(((__pyx_v_t[0]) + (0.5 * (__pyx_v_h[0]))), __pyx_f_28cython_numerical_integrators_add_dbl_vec_elementwise(__pyx_v_x, __pyx_v_tmp), __pyx_v_k3);
 ...
 *         tmp[i] =     h[0]*k3[i]             # <<<<<<<<<<<<<<
 * 
 *     f(t[0] + h[0]    , add_dbl_vec_elementwise(x, tmp), k4)
 */
    (__pyx_v_tmp[__pyx_v_i]) = ((__pyx_v_h[0]) * (__pyx_v_k3[__pyx_v_i]));
  }
 ...
 *     for i in range(ndim):
 */
  __pyx_v_f(((__pyx_v_t[0]) + (__pyx_v_h[0])), __pyx_f_28cython_numerical_integrators_add_dbl_vec_elementwise(__pyx_v_x, __pyx_v_tmp), __pyx_v_k4);

  /* "cython_numerical_integrators.pyx":59
 *     f(t[0] + h[0]    , add_dbl_vec_elementwise(x, tmp), k4)
 * 
 *     for i in range(ndim):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cython_numerical_integrators.pyx":60
 * 
 *     for i in range(ndim):
 *         x[i] = x[i] + 0.16666666666666667*(k1[i]+2*k2[i]+2*k3[i]+k4[i])*h[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":62
 *         x[i] = x[i] + 0.16666666666666667*(k1[i]+2*k2[i]+2*k3[i]+k4[i])*h[0]
 * 
 *     t[0] = t[0] + h[0]             # <<<<<<<<<<<<<<
 * 
 * cdef void func(double t, dbl_vec x, dbl_vec &ret):
 */
...
/* "cython_numerical_integrators.pyx":64
 *     t[0] = t[0] + h[0]
 * 
 * cdef void func(double t, dbl_vec x, dbl_vec &ret):             # <<<<<<<<<<<<<<
 *     cdef:
...
static void __pyx_f_28cython_numerical_integrators_func(CYTHON_UNUSED double __pyx_v_t, __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_x, __pyx_t_28cython_numerical_integrators_dbl_vec &__pyx_v_ret) {
  int __pyx_v_i;
  __Pyx_RefNannyDeclarations
  std::vector<double> ::size_type __pyx_t_1;
  int __pyx_t_2;
 ...
 */
  #ifndef CYTHON_WITHOUT_ASSERTIONS
  if (unlikely(!Py_OptimizeFlag)) {
    if (unlikely(!((__pyx_v_ret.size() == __pyx_v_x.size()) != 0))) {
      PyErr_SetNone(PyExc_AssertionError);
  ...
  /* "cython_numerical_integrators.pyx":70
 *     assert ret.size() == x.size()
 * 
 *     for i in range(ret.size()):             # <<<<<<<<<<<<<<
 *         ret[i] = x[i]
 ...
 */
    (__pyx_v_ret[__pyx_v_i]) = (__pyx_v_x[__pyx_v_i]);
  }
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("cython_numerical_integrators.func", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
 ...
 * 
 * @cython.cdivision(True)
 * cpdef double estimate_e(double h):             # <<<<<<<<<<<<<<
 *     cdef:
 *         double t0, tf
 */

static PyObject *__pyx_pw_28cython_numerical_integrators_1estimate_e(PyObject *__pyx_self, PyObject *__pyx_arg_h); /*proto*/
static double __pyx_f_28cython_numerical_integrators_estimate_e(double __pyx_v_h, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_t0;
  double __pyx_v_tf;
  double __pyx_v_t;
  __pyx_t_28cython_numerical_integrators_dbl_vec __pyx_v_ret;
  ...
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("estimate_e", 0);
 ...
 */
  try {
    __pyx_t_1 = __pyx_t_28cython_numerical_integrators_dbl_vec(1);
  } catch(...) {
    __Pyx_CppExn2PyErr();
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":84
 *     tf = 1.
 * 
 *     ret[0] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":86
 *     ret[0] = 1
 * 
 *     niter = int(cy_ceil((tf-t0)/h))             # <<<<<<<<<<<<<<
 * 
 *     t = t0
 */
  __pyx_v_niter = ((int)ceil(((__pyx_v_tf - __pyx_v_t0) / __pyx_v_h)));
 ...
 */
  ...
  /* "cython_numerical_integrators.pyx":90
 *     t = t0
 * 
 *     for i in range(niter):             # <<<<<<<<<<<<<<
 *         rk4_p(&t, ret, &h, func)
 ...
 *     return ret[0]
 */
    __pyx_f_28cython_numerical_integrators_rk4_p((&__pyx_v_t), __pyx_v_ret, (&__pyx_v_h), __pyx_f_28cython_numerical_integrators_func);
  }
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("cython_numerical_integrators.estimate_e", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_28cython_numerical_integrators_1estimate_e(PyObject *__pyx_self, PyObject *__pyx_arg_h); /*proto*/
static PyObject *__pyx_pw_28cython_numerical_integrators_1estimate_e(PyObject *__pyx_self, PyObject *__pyx_arg_h) {
  double __pyx_v_h;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("estimate_e (wrapper)", 0);
  assert(__pyx_arg_h); {
    __pyx_v_h = __pyx_PyFloat_AsDouble(__pyx_arg_h); if (unlikely((__pyx_v_h == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 74, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_numerical_integrators.estimate_e", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_28cython_numerical_integrators_estimate_e(__pyx_self, ((double)__pyx_v_h));
...
static PyObject *__pyx_pf_28cython_numerical_integrators_estimate_e(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_h) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("estimate_e", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_28cython_numerical_integrators_estimate_e(__pyx_v_h, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"estimate_e", (PyCFunction)__pyx_pw_28cython_numerical_integrators_1estimate_e, METH_O, 0},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  /* "cython_numerical_integrators.pyx":4
 * 
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
