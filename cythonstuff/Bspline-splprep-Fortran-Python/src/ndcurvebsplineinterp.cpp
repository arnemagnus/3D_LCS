...
static int __pyx_pf_20ndcurvebsplineinterp_26NDCurveBSplineInterpolator___init__(struct __pyx_obj_20ndcurvebsplineinterp_NDCurveBSplineInterpolator *__pyx_v_self, __Pyx_memviewslice __pyx_v_x, int __pyx_v_kx, int __pyx_v_wraparound, int __pyx_v_extrap); /* proto */
 ...
 *     def __init__(self, double[:,::1] x, int kx = 3, bint wraparound = False,             # <<<<<<<<<<<<<<
 *             bint extrap = False):
 *         cdef:
 */
...
static int __pyx_pw_20ndcurvebsplineinterp_26NDCurveBSplineInterpolator_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_kx,&__pyx_n_s_wraparound,&__pyx_n_s_extrap,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  2:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_wraparound);
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0]); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 38, __pyx_L3_error)
    if (values[1]) {
      __pyx_v_kx = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_kx == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    } else {
      __pyx_v_kx = ((int)3);
    }
    if (values[2]) {
      __pyx_v_wraparound = __Pyx_PyObject_IsTrue(values[2]); if (unlikely((__pyx_v_wraparound == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    } else {
      __pyx_v_wraparound = ((int)0);
    }
    if (values[3]) {
      __pyx_v_extrap = __Pyx_PyObject_IsTrue(values[3]); if (unlikely((__pyx_v_extrap == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
    } else {

      /* "ndcurvebsplineinterp.pyx":39
 *     @cython.cdivision(True)
 *     def __init__(self, double[:,::1] x, int kx = 3, bint wraparound = False,
 *             bint extrap = False):             # <<<<<<<<<<<<<<
 *         cdef:
 ...
 */
  ...
  __pyx_r = __pyx_pf_20ndcurvebsplineinterp_26NDCurveBSplineInterpolator___init__(((struct __pyx_obj_20ndcurvebsplineinterp_NDCurveBSplineInterpolator *)__pyx_v_self), __pyx_v_x, __pyx_v_kx, __pyx_v_wraparound, __pyx_v_extrap);
...
static int __pyx_pf_20ndcurvebsplineinterp_26NDCurveBSplineInterpolator___init__(struct __pyx_obj_20ndcurvebsplineinterp_NDCurveBSplineInterpolator *__pyx_v_self, __Pyx_memviewslice __pyx_v_x, int __pyx_v_kx, int __pyx_v_wraparound, int __pyx_v_extrap) {
  ...
  ItpCont *__pyx_t_10;
  int __pyx_t_11;
  __pyx_t_20ndcurvebsplineinterp_dbl_vec __pyx_t_12;
  __pyx_t_20ndcurvebsplineinterp_dbl_vec_vec __pyx_t_13;
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_self->ndim); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_unsigned_int(__pyx_v_npts); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = NULL;
  ...
  if (!__pyx_t_3) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_6, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GOTREF(__pyx_t_2);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_6)) {
      ...
      __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_6, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_6)) {
      PyObject *__pyx_temp[2] = {__pyx_t_3, __pyx_t_4};
      __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_6, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    } else
 ...
 */
    try {
      __pyx_t_10 = new ItpCont();
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(0, 56, __pyx_L1_error)
    }
    (__pyx_v_self->c_classes[__pyx_v_i]) = __pyx_t_10;
  }

  /* "ndcurvebsplineinterp.pyx":58
 *             self.c_classes[i] = new ItpCont()
 * 
 *         if wraparound:             # <<<<<<<<<<<<<<
 *             x_ = dbl_vec(npts+1)
 *             s_internal = dbl_vec(npts+1)
 */
  __pyx_t_11 = (__pyx_v_wraparound != 0);
  if (__pyx_t_11) {

    /* "ndcurvebsplineinterp.pyx":59
 * 
 *         if wraparound:
 *             x_ = dbl_vec(npts+1)             # <<<<<<<<<<<<<<
 *             s_internal = dbl_vec(npts+1)
 ...
 */
    try {
      __pyx_t_12 = __pyx_t_20ndcurvebsplineinterp_dbl_vec((__pyx_v_npts + 1));
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(0, 59, __pyx_L1_error)
    }
    __pyx_v_x_ = __pyx_t_12;

    /* "ndcurvebsplineinterp.pyx":60
 *         if wraparound:
 *             x_ = dbl_vec(npts+1)
 *             s_internal = dbl_vec(npts+1)             # <<<<<<<<<<<<<<
 *         else:
 ...
 *         else:
 *             x_ = dbl_vec(npts)             # <<<<<<<<<<<<<<
 *             s_internal = dbl_vec(npts)
 *         pos_ = dbl_vec_vec(self.ndim, x_)
 */
  /*else*/ {
    try {
      __pyx_t_12 = __pyx_t_20ndcurvebsplineinterp_dbl_vec(__pyx_v_npts);
    } catch(...) {
      __Pyx_CppExn2PyErr();
 ...
 */
  try {
    __pyx_t_13 = __pyx_t_20ndcurvebsplineinterp_dbl_vec_vec(__pyx_v_self->ndim, __pyx_v_x_);
  } catch(...) {
    __Pyx_CppExn2PyErr();
    __PYX_ERR(0, 64, __pyx_L1_error)
  }
  __pyx_v_pos_ = __pyx_t_13;

  /* "ndcurvebsplineinterp.pyx":67
 * 
 * 
 ...
 */
      ...
      ((__pyx_v_pos_[__pyx_v_j])[__pyx_v_i]) = (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_16 * __pyx_v_x.strides[0]) )) + __pyx_t_17)) )));
    }
  }

  /* "ndcurvebsplineinterp.pyx":71
 *                 pos_[j][i] = x[i,j]
 * 
 *         if wraparound:             # <<<<<<<<<<<<<<
 *             for j in range(self.ndim):
 ...
 */
      ...
      ((__pyx_v_pos_[__pyx_v_j])[__pyx_v_npts]) = (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_18 * __pyx_v_x.strides[0]) )) + __pyx_t_19)) )));
    }
 ...
 *             diff2 = 0
 */
  (__pyx_v_s_internal[0]) = 0.0;

  /* "ndcurvebsplineinterp.pyx":77
 * 
 *         s_internal[0] = 0
 *         for j in range(1,npts):             # <<<<<<<<<<<<<<
 *             diff2 = 0
 ...
 */
    ...
    /* "ndcurvebsplineinterp.pyx":79
 *         for j in range(1,npts):
 *             diff2 = 0
 *             for i in range(self.ndim):             # <<<<<<<<<<<<<<
 *                 diff2 += c_pow(pos_[i][j]-pos_[i][j-1],2)
 *             s_internal[j] = s_internal[j-1] + c_sqrt(diff2)
 */
    __pyx_t_14 = __pyx_v_self->ndim;
    for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
      __pyx_v_i = __pyx_t_15;

      /* "ndcurvebsplineinterp.pyx":80
 *             diff2 = 0
 *             for i in range(self.ndim):
 *                 diff2 += c_pow(pos_[i][j]-pos_[i][j-1],2)             # <<<<<<<<<<<<<<
 *             s_internal[j] = s_internal[j-1] + c_sqrt(diff2)
 ...
 *         if wraparound:
 */
    (__pyx_v_s_internal[__pyx_v_j]) = ((__pyx_v_s_internal[(__pyx_v_j - 1)]) + sqrt(__pyx_v_diff2));
  }

  /* "ndcurvebsplineinterp.pyx":83
 *             s_internal[j] = s_internal[j-1] + c_sqrt(diff2)
 * 
 *         if wraparound:             # <<<<<<<<<<<<<<
 *             diff2 = 0
 ...
 */
    ...
    /* "ndcurvebsplineinterp.pyx":85
 *         if wraparound:
 *             diff2 = 0
 *             for i in range(self.ndim):             # <<<<<<<<<<<<<<
 *                 diff2 += c_pow(pos_[i][npts]-pos_[i][npts-1],2)
 *             s_internal[npts] = s_internal[npts-1] + c_sqrt(diff2)
 */
    __pyx_t_8 = __pyx_v_self->ndim;
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      __pyx_v_i = __pyx_t_9;

      /* "ndcurvebsplineinterp.pyx":86
 *             diff2 = 0
 *             for i in range(self.ndim):
 *                 diff2 += c_pow(pos_[i][npts]-pos_[i][npts-1],2)             # <<<<<<<<<<<<<<
 *             s_internal[npts] = s_internal[npts-1] + c_sqrt(diff2)
 ...
 */
    ...
    /* "ndcurvebsplineinterp.pyx":87
 *             for i in range(self.ndim):
 *                 diff2 += c_pow(pos_[i][npts]-pos_[i][npts-1],2)
 *             s_internal[npts] = s_internal[npts-1] + c_sqrt(diff2)             # <<<<<<<<<<<<<<
 * 
 *         for j in range(s_internal.size()):
 */
    (__pyx_v_s_internal[__pyx_v_npts]) = ((__pyx_v_s_internal[(__pyx_v_npts - 1)]) + sqrt(__pyx_v_diff2));
 ...
 */
  ...
  /* "ndcurvebsplineinterp.pyx":89
 *             s_internal[npts] = s_internal[npts-1] + c_sqrt(diff2)
 * 
 *         for j in range(s_internal.size()):             # <<<<<<<<<<<<<<
 *             s_internal[j] /= s_internal[s_internal.size()-1]
 * 
 */
  __pyx_t_20 = __pyx_v_s_internal.size();
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_20; __pyx_t_8+=1) {
    __pyx_v_j = __pyx_t_8;

    /* "ndcurvebsplineinterp.pyx":90
 * 
 *         for j in range(s_internal.size()):
 *             s_internal[j] /= s_internal[s_internal.size()-1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_9 = __pyx_v_j;
    (__pyx_v_s_internal[__pyx_t_9]) = ((__pyx_v_s_internal[__pyx_t_9]) / (__pyx_v_s_internal[(__pyx_v_s_internal.size() - 1)]));
  }

  /* "ndcurvebsplineinterp.pyx":92
 *             s_internal[j] /= s_internal[s_internal.size()-1]
 * 
 *         if extrap:             # <<<<<<<<<<<<<<
 *             ext = 1
 *         else:
 */
  __pyx_t_11 = (__pyx_v_extrap != 0);
  if (__pyx_t_11) {

    /* "ndcurvebsplineinterp.pyx":93
 * 
 *         if extrap:
 *             ext = 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /* "ndcurvebsplineinterp.pyx":97
 *             ext = 0
 * 
 *         if wraparound:             # <<<<<<<<<<<<<<
 *             for i in range(self.ndim):
 *                 self.c_classes[i].init_interp(&s_internal[0],&pos_[i][0],kx,npts+1,ext)
 */
  __pyx_t_11 = (__pyx_v_wraparound != 0);
  if (__pyx_t_11) {

    /* "ndcurvebsplineinterp.pyx":98
 * 
 *         if wraparound:
 *             for i in range(self.ndim):             # <<<<<<<<<<<<<<
 *                 self.c_classes[i].init_interp(&s_internal[0],&pos_[i][0],kx,npts+1,ext)
 ...
 */
      try {
        (__pyx_v_self->c_classes[__pyx_v_i])->init_interp((&(__pyx_v_s_internal[0])), (&((__pyx_v_pos_[__pyx_v_i])[0])), __pyx_v_kx, (__pyx_v_npts + 1), __pyx_v_ext);
      } catch(...) {
        __Pyx_CppExn2PyErr();
 ...
 */
  ...
  /* "ndcurvebsplineinterp.pyx":101
 *                 self.c_classes[i].init_interp(&s_internal[0],&pos_[i][0],kx,npts+1,ext)
 *         else:
 *             for i in range(self.ndim):             # <<<<<<<<<<<<<<
 *                 self.c_classes[i].init_interp(&s_internal[0],&pos_[i][0],kx,npts,ext)
 *         for i in range(npts):
 */
  /*else*/ {
    __pyx_t_8 = __pyx_v_self->ndim;
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      ...
      /* "ndcurvebsplineinterp.pyx":102
 *         else:
 *             for i in range(self.ndim):
 *                 self.c_classes[i].init_interp(&s_internal[0],&pos_[i][0],kx,npts,ext)             # <<<<<<<<<<<<<<
 *         for i in range(npts):
 *             self.s[i] = s_internal[i]
 */
      try {
        (__pyx_v_self->c_classes[__pyx_v_i])->init_interp((&(__pyx_v_s_internal[0])), (&((__pyx_v_pos_[__pyx_v_i])[0])), __pyx_v_kx, __pyx_v_npts, __pyx_v_ext);
      } catch(...) {
        __Pyx_CppExn2PyErr();
 ...
 */
    ...
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_self->s.data) + __pyx_t_21)) )) = (__pyx_v_s_internal[__pyx_v_i]);
  }
 ...
 */
    try {
      __pyx_t_3 = (__pyx_v_self->c_classes[__pyx_v_i])->eval_interp(__pyx_v_s, 0);
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(0, 113, __pyx_L1_error)
    }
    __pyx_t_4 = __pyx_v_i;
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_self->ret.data) + __pyx_t_4)) )) = __pyx_t_3;
  }

  /* "ndcurvebsplineinterp.pyx":114
 *         for i in range(self.ndim):
 *             self.ret[i] = self.c_classes[i].eval_interp(s,0)
 *         return np.copy(self.ret)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_copy); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __pyx_memoryview_fromslice(__pyx_v_self->ret, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_8 = NULL;
  ...
  if (!__pyx_t_8) {
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 114, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else {
    #if CYTHON_FAST_PYCALL
    ...
    #endif
    {
      ...
      __pyx_t_6 = 0;
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_9, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 114, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
 ...
 *                 del self.c_classes[i]
 */
    __pyx_t_3 = (((__pyx_v_self->c_classes[__pyx_v_i]) != NULL) != 0);
    if (__pyx_t_3) {
...
static PyObject *__pyx_pf_20ndcurvebsplineinterp_26NDCurveBSplineInterpolator_1s___get__(struct __pyx_obj_20ndcurvebsplineinterp_NDCurveBSplineInterpolator *__pyx_v_self) {
  ...
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_self->s.memview)) {PyErr_SetString(PyExc_AttributeError,"Memoryview is not initialized");__PYX_ERR(0, 30, __pyx_L1_error)}
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_self->s, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
 ...
 *     raise TypeError("self.c_classes cannot be converted to a Python object for pickling")
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_self_c_classes_cannot_be_convert); if (unlikely(!__pyx_tuple_)) __PYX_ERR(1, 2, __pyx_L1_error)
 ...
 *     raise TypeError("self.c_classes cannot be converted to a Python object for pickling")             # <<<<<<<<<<<<<<
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_self_c_classes_cannot_be_convert); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(1, 4, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initndcurvebsplineinterp(void); /*proto*/
PyMODINIT_FUNC initndcurvebsplineinterp(void)
#else
PyMODINIT_FUNC PyInit_ndcurvebsplineinterp(void); /*proto*/
PyMODINIT_FUNC PyInit_ndcurvebsplineinterp(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_ndcurvebsplineinterp(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ndcurvebsplineinterp", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_20ndcurvebsplineinterp_NDCurveBSplineInterpolator) < 0) __PYX_ERR(0, 27, __pyx_L1_error)
  __pyx_type_20ndcurvebsplineinterp_NDCurveBSplineInterpolator.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "NDCurveBSplineInterpolator", (PyObject *)&__pyx_type_20ndcurvebsplineinterp_NDCurveBSplineInterpolator) < 0) __PYX_ERR(0, 27, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_20ndcurvebsplineinterp_NDCurveBSplineInterpolator) < 0) __PYX_ERR(0, 27, __pyx_L1_error)
