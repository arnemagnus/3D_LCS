...
interpolation of quadrivariate time-dependent vector fields in R^3, making use of
...
cdef class TrivectorQuadrivariateSpline:
    """
    ...
    Methods defined here:
        TrivectorQuadrivariateSpline.__init__(t,x,y,z,v,kt,kx,ky,kz,extrap)
        TrivectorQuadrivariateSpline.__call__(t,pos)
        TrivectorQuadrivariateSpline.jac(t,pos)
    ...
    def __init__(self, double[::1] t, double[::1] x, double[::1] y, double[::1] z, double[:,::1] v,
        ...
        Constructor for a TrivectorQuadrivariateSpline instance.
